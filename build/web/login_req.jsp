...
<%
    ...
    //si il n'y a aucun cookie de session on crée la connection
    if (con == null) {
    ...
    //On crée des objets utilisateur et opérateur identifiés par leur mail car on ne sait pas 
    //si la personne qui se connecte est un utilisateur ou un opérateur
