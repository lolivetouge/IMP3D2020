...
<html>
    ...
    <%
        //Affichage de la liste des opérateurs 2020
        ...
        out.print("];");
        //Affichage de la liste des utilisateurs 2020
        ...
        out.print("];");
        //Affichage de la liste des jobs 2020
 ...
            
            <%--POPUP pour confirmer la suppression d'un utilisateur 2020--%>
 ...
                </div>
            ...
            <%--POPUP qui s'ouvre pour enregistrer un nouvel opérateur 2020--%>
            ...
            <%--POPUP pour confirmer la suppression d'un opérateur 2020--%>
 ...
                </div>
            ...
            <%--POPUP pour afficher le détail d'un job en cours 2020--%>
 ...
                </div>
            ...
            <%--POPUP confirmer suppression suivi du job utilisateur--%>
