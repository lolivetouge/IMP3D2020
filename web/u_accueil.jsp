...
<html>
    ...
    <%   
        //On récupère la liste des jobs et leurs contenus et on les affiche (2020)
    ...
    %>
                ...
                <%--Affichage du titre des colonnes du tableau--%>
                <center>
               ...
                    <tbody>
    <%
        //On récupère une partie des attributs des jobs pour en afficher leur état 2020
        i = 0;
        for (Job job : jobs) {
            out.print("<tr id='j" + i + "'>");
            ...
            out.print("<th>");
            //Affichage des boutons pour voir les attributs précis de l'etat du job
            //Bouton pour avoir des détails sur le suivi des jobs
            //Bouton pour supprimer le suivi du job
 ...
                </div>
            ...
            <%--POPUP confirmer suppression suivi du job--%>
